...
export default async function AboutPage({ params }: { params: Promise<{ locale: string }> }) {
  ...
  const data = l === 'zh' ? {
    ...
    story: { h: '我们的故事', p: '深圳晨旭通科技有限公司（RisunicPower）成立于2014年，是一家专注于电源解决方案研发、生产和销售的科技企业。公司总部位于中国深圳，拥有12000㎡的生产基地和越南海外工厂，年产能超过500万台电源产品。产品通过CE、FCC、UL、RoHS、ISO 9001等国际认证，远销全球30多个国家和地区。' },
    ...
    story: { h: '私たちのストーリー', p: '深セン晨旭通科技有限公司（RisunicPower）は2014年に設立され、電源ソリューションの研究開発、製造、販売に特化した企業です。本社は中国深セン、12,000㎡の生産拠点とベトナム工場を有し、年間500万台以上を生産。CE、FCC、UL、RoHS、ISO 9001等の認証を取得し、世界30カ国以上に輸出しています。' },
