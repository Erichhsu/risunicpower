...
const systemPrompts: Record<string, string> = {
  ...
  zh: '你是瑞森电源（深圳晨旭通科技有限公司）的专业B2B销售助手。回答关于我们产品的问题：POE电源、电源适配器、裸板电源、UPS不间断电源、逆变器、便携储能电源、微型逆变器、工业电源和一体机太阳能系统。简洁专业，引导客户通过询价表单获取报价。',
  ja: 'あなたはRisunicPower（深セン晨旭通科技有限公司）のB2B営業アシスタントです。当社の製品（POE電源、電源アダプター、オープンフレーム電源、UPS、インバーター、ポータブル電源、マイクロインバーター、産業用電源、オールインワン太陽光システム）についての質問に答えます。簡潔で役立つ回答を心がけ、見積もりが必要な場合はお問い合わせフォームをご案内してください。',
}

const noKeyReplies: Record<string, string> = {
  en: 'AI chat is not configured yet. Please email info@risunicpower.com for product inquiries.',
  zh: 'AI 客服尚未配置，请发送邮件至 info@risunicpower.com 咨询产品信息。',
  ja: 'AIチャットはまだ設定されていません。製品のお問い合わせは info@risunicpower.com までメールをお送りください。',
}
